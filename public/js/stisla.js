...
function setupNavbarScrollState() {
    $(window).scroll(function () {
        ...
        const navbarHeight = $(selectors.mainNavbar).outerHeight();
        const isMenuOpen = (_a = navbar === null || navbar === void 0 ? void 0 : navbar.classList.contains(navbarClasses.menuOpen)) !== null && _a !== void 0 ? _a : false;
...
function setupCollapseToggles() {
    document.querySelectorAll(selectors.collapseToggle).forEach((toggle) => {
        ...
        toggle.addEventListener("click", (event) => {
            ...
            navbar === null || navbar === void 0 ? void 0 : navbar.classList.toggle(navbarClasses.menuOpen, isExpanded);
            navbar === null || navbar === void 0 ? void 0 : navbar.classList.toggle(navbarClasses.dark, isExpanded || window.scrollY > window.innerHeight / 10);
